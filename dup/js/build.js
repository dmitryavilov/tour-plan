var app = new Vue({
    ...
    data: {
        ...
        service: [
            {
                img: {
                    backgroundImage: "url('../img/service/1.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/2.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/3.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/4.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/5.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/6.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/7.webp')", 
            ...
            {
                img: {
                    backgroundImage: "url('../img/service/8.webp')", 
